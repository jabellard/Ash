...
const int YY_parse_CLASS::AMPERSAND=258;
const int YY_parse_CLASS::GREAT=259;
const int YY_parse_CLASS::LESS=260;
const int YY_parse_CLASS::PIPE=261;
const int YY_parse_CLASS::NEWLINE=262;
const int YY_parse_CLASS::BAD_TOKEN=263;
...
static const short yyprhs[] = {     0,
     0,     2,     4,     7,     8,    11,    15,    17,    20,    23,
    27,    30,    31,    33,    34,    36,    38,    41,    46,    48,
    51
};

static const short yyrhs[] = {    10,
     0,    10,     0,    14,    13,     0,     0,    12,    14,     0,
    16,     6,    15,     0,    15,     0,     5,    10,     0,     4,
    10,     0,    11,     4,    10,     0,    18,    17,     0,     0,
     3,     0,     0,     7,     0,     9,     0,     9,     7,     0,
    16,    18,    19,    20,     0,    20,     0,    22,    21,     0,
    21,     0
};
...
static const short yyrline[] = { 0,
    33,    71,    86,    92,   100,   123,   128,   133,   142,   150,
   160,   165,   171,   179,   186,   192,   198,   205,   223,   228,
   233
};

static const char * const yytname[] = {   "$","error","$illegal.","AMPERSAND",
"GREAT","LESS","PIPE","NEWLINE","BAD_TOKEN","SEMICOLON","ID","'2'","cmd","arg",
"arg_list","simple_command","simple_command_list","redirection","redirection_list",
"background","pipeline_terminator","pipeline","pipeline_list",""
};
#endif
...
static const short yydefact[] = {     0,
    15,    16,     1,     4,     7,    12,    19,    21,     0,    17,
     5,     0,    14,    20,     2,     3,     6,    13,     0,     0,
     0,    11,     0,     9,     8,     0,    18,    10,     0,     0
};

static const short yydefgoto[] = {     4,
    16,    11,     5,     6,    22,    13,    23,     7,     8,     9
};

static const short yypact[] = {     4,
-32768,    -5,-32768,-32768,-32768,     2,-32768,-32768,     0,-32768,
     5,     6,     1,-32768,-32768,-32768,-32768,-32768,     7,     8,
    15,-32768,    -6,-32768,-32768,    10,-32768,-32768,    21,-32768
};

static const short yypgoto[] = {-32768,
-32768,-32768,    11,-32768,-32768,-32768,-32768,    -1,    16,-32768
};
...
static const short yytable[] = {    29,
     1,    10,     2,    18,    19,    20,     1,    12,     2,     3,
     1,    21,     2,     3,    15,     3,    24,    25,    26,    28,
    30,    27,    17,     0,    14
};

static const short yycheck[] = {     0,
     7,     7,     9,     3,     4,     5,     7,     6,     9,    10,
     7,    11,     9,    10,    10,    10,    10,    10,     4,    10,
     0,    23,    12,    -1,     9
};
...
#line 35 "parser.y"
{
		...
		if (i == 0)
		{
			...
			i = 1;
			// insert the command
			insert_arg_in_simple_command(sc, yyvsp[0].str);
...
#line 135 "parser.y"
{
		...
		// set the input file
		sp->input_file = strdup(yyvsp[0].str);
	;
    break;}
case 9:
#line 143 "parser.y"
{
		...
		// set the output file
		sp->output_file = strdup(yyvsp[0].str);
	;
    break;}
case 10:
#line 151 "parser.y"
{
		...
		// set the error file
		sp->error_file = strdup(yyvsp[0].str);
	;
    break;}
case 11:
#line 162 "parser.y"
